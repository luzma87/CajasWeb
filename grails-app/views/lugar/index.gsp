		...
		<div id="list-lugar" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'lugar.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${lugarInstanceList}" status="i" var="lugarInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${lugarInstance.id}">${fieldValue(bean: lugarInstance, field: "nombre")}</g:link></td>
